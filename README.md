...
TelegramSaleStars — Telegram-бот для продажи звёзд. Пользователи могут купить звёзды через CryptoBot (Crypto Pay), оплатить счёт и получить доставку/назначение звёзд на указанный аккаунт; владелец бота получает статистику и инструменты администрирования.
...
* [Docker — базовая настройка](#docker--базовая-настройка)
* [Администрирование и команды](#администрирование-и-команды)
...
<h2 id="что-реализовано">Что реализовано</h2>
...
<h2 id="как-это-работает-кратко">Как это работает (кратко)</h2>
...
<h2 id="быстрый-старт-локально">Быстрый старт (локально)</h2>
...
<h2 id="docker--базовая-настройка">Docker — базовая настройка</h2>
...
<h2 id="администрирование-и-команды">Администрирование и команды</h2>
...
<h2 id="рекомендации-по-безопасности">Рекомендации по безопасности</h2>
